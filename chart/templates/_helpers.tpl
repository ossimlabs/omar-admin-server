{{- define "omar-admin-server.imagePullSecret" }}
...
{{- define "omar-admin-server.envVars" -}}
...
{{- define "omar-admin-server.volumeMounts.configmaps" -}}
...
{{- define "omar-admin-server.volumeMounts" -}}
{{- include "omar-admin-server.volumeMounts.configmaps" . -}}
{{- end -}}

{{- define "omar-admin-server.volumes.configmaps" -}}
{{- range $configmap := .Values.configmaps}}
- name: {{ $configmap.internalName | quote }}
  configMap:
...
{{- define "omar-admin-server.volumes" -}}
{{- include "omar-admin-server.volumes.configmaps" . -}}
{{- end -}}
